...
install python2.7 from http://www.python.org for your Operation System. 
You can try out newer or older version of python at your own risk. 

install pygame1.9.1 for your python verson from http://www.pygame.org 
for your Operation System. 
You can try out newer or older versions of pygame at your own risk.

make sure you have the file schwarzweiss.py in your folder and in this
...
it is probably less complicated to open schwarzweiss_start.py with your
...
try double-clicking schwarzweiss.py , 
...
https://github.com/horstjens/schwarzweiss

=== customizing ===

you can customzie the game by changing the values in the game menu
or by changing values inside the class Config of the file
schwarzweiss.py (inside the folder data). 
